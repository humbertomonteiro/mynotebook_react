            ...
            <div id='note' className={btnShow.clicked ?  '#note active' : '#note'}>
                <div className='container-show-notes'>
                    <div>
                        ...
                        <p>Vamos usar como se fosse um cadastro de cliente. No terminal vamos criar essa branch com o comando <strong>git branch cadastro-cliente</strong>
