            ...
            <div className="content">
                <div className='content-notes'>
                    ...
                    <div className='cont'>
                        <h1>Git</h1>
                        <p>
                            Para ter seus arquivos salvos e faceis de visualizar você pode usar o GitHub, um repositorio muito famoso.
                        </p>
                ...
                <div id='note' className={btnShow.clicked ?  '#note active' : '#note'}>
                    <div className='cont-note'>
                        <div className='cont-note-info'>
                            ...
                            <p>
                                E quando vamos melhorando ou adicionando funcionalidades a nossas aplicações,
                            ...
                            <p>
                                ...
                                voltar a como projeto era e se não tivessemos esse programa, teriamos muitos problemas.
                            ...
                            <p>
                                Para usar como exemplo vamos criar duas páginas, index.html e script.js. No terminal vamos usar o comando
                            ...
                            <p>
                                Podemos usar um comando para preparar um de cada vez. Dessa forma: <strong>git add index.html</strong>. Se quisermos
                            ...
                            <p>
                                Com os arquivos preparados para commit usaremos o comando <strong>git commit -m ""</strong> (dentro das aspas vamos adicionar
                            ...
                            <p>
                                Pronto! Vizemos nosso primeiro commit, para visualizarmos todos os commits podemos usar o comando git log.</p>
                            <h3>Ignore Aquivos</h3>
                            <p>
                                Alguns arquivos da sua aplicação podem ter algo que você não queira dexar visivel. Senhas, Dados pessoais, entre outros motivos.
                            ...
                            <p>
                                Então a forma mais simples de resolver esse problema é criar um arquivo nomeado assim: <strong>.gitignore</strong>
                                Em seguida dentro desse arquivo escrevermos o nome dos arquivos que não vamos commitar. Dessa forma reolvemos muito simplesmente o problema.
                            </p>
                            <h3>Branch</h3>
                            <p>
                                Um conceito muito importante é o de branch, note que quando você abre o terminal com o bash do git, vai aparecer um
                            ...
                            <p>
                                Vamos supor que recebemos uma tarefa de adicionar uma funcionalidade de cadastro no nosso app, não é interessante
                            ...
                            <p>
                                Muito simples, para criar uma branch development é só escrever o comando <strong>git branch development</strong>.
                            ...
                            <p>
                                Pensem em branch como se fossem pequenas pastas dentro do nosso repositório. Para podermos mudar de branch usamos o
                            ...
                            <p>
                                Vamos usar como se fosse um cadastro de cliente. No terminal vamos criar essa branch com o comando <strong>git branch cadastro-cliente</strong>
                                Em seguida vamos vê os ambientes que temos com o comando <strong>git branch</strong>, então vamos entrar nesse ambiente com o comando
                                <strong>git checkout cadastro-cliente</strong>. No exemplo vamos criar uma pasta cadastro-cliente e dentro dessa pasta um arquivo com
                                mesmo nome.
                            </p>
                            <p>
                                Se usarmos o comando git status veremos que temos a pasta criada não preparada para commitar, então vamos preparar ela e tambem
                            ...
                            <p>
                                Pronto, agora que você viu como funciona essa mudança de ambientes na prática, vamos mudar de branch mais uma vez com o comando
