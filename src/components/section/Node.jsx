...
export default function SectionNode() {
    ...
    return (
        <section id='node' className='container-notes bg-none'>
                    ...
                    <div className="cont-note">
                        <div className="cont-note-info">
                            ...
                            <p>
                                ...
                                que facilita na hora de colocar uma aplicação no ar e por isso não precisar gastar tanto para manter uma
                                aplicação. Tambem tem muita harmonia com o front-end, pois ambos ultilizam javascript. Todas essas 
                                caracteristicas fazem com que o Node.js seja rápido, escalavel e consequêntemente muito forte no mercado.
                            </p>

                            <h2>Sistema de módulos</h2>

                            <p>
                                O node funciona com <strong>módulos</strong> (módulos são pastas com arquivos que tem funcionalidades).
                                Temos três tipos de módulos. Os que vem por padrão no node, como o path, o fs e o http.
                                Tem os módulos de terceiros, como por exemplo o express, o nodemon, o axios e muitos outros.
                                E também podemos fazer nossos próprio módulos.
                            </p>

                            <h2>npm</h2>

                            <p>
                                O npm é o gerenciador de pacotes do node. Essa ferramenta vai deixar sua aplicação organizada e
                                otimizada. O npm hospeda milhares de módulos grátis que você pode baixar e usar nas suas aplicações.
                                O npm é baixado quando você baixa o node.js na sua máquina.
                            </p>
                            ...
                            <p>
                                Package.json é um arquivo de configuração para seu projeto, vai lhe auxiliar em deixar suas bibliotecas
                                e frameworks atualizados e/ou com as suas versões desejadas. Para criar seu arquivo package.json basta
                                dar o comando no terminal <strong>npm init</strong>. O node vai lhe fazer algumas perguntas de configurações, mas como
                                são muito simples de serem alteradas, geralmente usamos no lugar do npm init, o comando <strong>npm init -y</strong> que
                                vai gerar o arquivo com configurações padrões.
                            </p>

                            <h3>Scripts</h3>

                            <p>
                                O package.json vai te auxiliar em usar suas dependências com os <strong>scripts</strong> (são formas de chamar
                                alguma dependência configurada) e podemos usar essa configuração com um comando simples, como npm <strong>start</strong>,
                                (é uma palavra reservada do node), ou caso preferir você pode usar qualquer nome que queira dar pro seu script. Caso use uma palavra
                                reservada, como o start, basta apenas executar o comando <strong>npm start</strong>, que seu script vai funcionar. Se caso
                                você quiser dá um nome aleatório você vai precisar usar o <strong>run</strong> para chamar seu script. Vamos  exemplificar
                                usando um script com o nome dev, que não é uma palavra reservada. Esse script só vai rodar caso chame da
                                seguinte forma: <strong>npm run dev</strong>. Para ver como funciona na prática os scripts vá para a parte de módulos de
                                terceiros e veja como usamos uma biblioteca chamada nodemon.
                            </p>
                            ...
                            <p>
                                Os módulos de terceiros são baixados com o npm, o gerenciador de pacotes do node. É muito simples baixar
                                módulos com o npm. Só precisamos usar o comando <strong>npm install</strong> e em seguida o nome da biblioteca ou framework
                                que queremos baixar para nosso projeto. (Ou <strong>npm i</strong> é o nome do módulo, que é uma forma abreviada.)
                            </p>
                            ...
                            <article>
                                ...
                                <p>
                                    Caso baixe um pacote com o npm sem ter criado o package.json antes, não tem problema. O arquivo 
                                    package.json, packege-lock.json que serve para deixar as dependências baixadas na versão correta e a 
                            ...
                            <h3>node_modules</h3>
                            <p>
                                Quando baixamos alguma dependência, a pasta node_modules é criada para armazenar essa dependência no seu 
                                projeto. Essa pasta é muito grande e não precisamos mandar ela para o repositório remoto, pois é muito 
                                simples de baixar as dependências que estão no arquivo package.json com o comando <strong>npm i</strong>.
                            </p>

                            <h3>.gitignore</h3> 
                            Para ignorarmos a pastas que não queremos mandar para o repositório remoto, criamos um arquivo nomeada como 
                            .gitignore na raiz do projeto. Para adicionamos as pastas e ou arquivos que queremos ignorar vamos apenas 
                            escrever o nome nessa pasta lá dentro. Como exemplo vamos adicionar o node_modules e pronto. Esse arquivo 
                            não será enviado para seu repositório remoto.

                            <h3>baixando globalmente</h3>
                            <p>Também podemos baixar as dependências globalmente usando o <strong>npm i -g</strong> e em seguida o nome da dependência. 
                                Baixar globalmente quer dizer que todos os seus projetos terão essa dependência disponível para ultilizar,
                                pois não será adicionada apenas na pasta node_modules do seu projeto e sim em outra paste que basta chamar 
                                o nome no terminal e será atendido seu comando.
                            </p>
                            ...
                            <p>
                                Já vimos como baixar dependências de terceiros, agora vamos importar essas dependências para conseguirmos 
                                ultiliza-las. O método require faz esse trabalho para nós. Vamos exemplificar usando o lodash ,uma 
                                biblioteca muito conhecida e utilizada. Vamos baixa-la usando o comando <strong>npm i lodash</strong> e esperamos baixar 
                                todos os pacates.
                                Agora precisamos importar essa dependência. Seria assim: <pre>const lodash = require('lodash')</pre>.
                                Uma sintaxe muito simples. Atribuímos a uma constante o nome do módulo e em seguida chamamos o método 
                                require com o nome do módulo que queremos como parâmetro. Geralmente usamos o mesmo nome do pacote na constante.
                            </p>
                            ...
                            <article>
                                ...
                                <p>
                                    Perceba que o require recebe o nome do pacote sem o caminho relativo. Isso acontece porque a pasta do 
                                    módulo tem o arquivo índex. Então já fica de fica quando formos fazer nossos próprios módulos usarmos 
                                    o nome do arquivo principal como índex para podermos usar essa sintaxe mais enxuta.
                                </p>
                            </article>
                            ...
                            <article>
                                <h3>Observação</h3>
                                <p>
                                    As dependências que são instaladas tem sua versão informada. Assim: <strong>"express": "^4.18.2"</strong>.
                                    Normalmente será assim: um sinal e uma sequêcia com três números. O primeiro número é o minor,
                                    o segundo é o major e o último o fix. o sinal que está no exemplo é o circunflexo. Isso quer
                                    dizer que a versão da sua dependencia poderar atualizar automaticamente o mejor até a versão 99,
                                    mas não poderar atualizar o minor que é o primeiro número.
                                </p>
                                <p>
                                    Podemos alterar o sinal das nossas dependências usando o ~ no lugar do ^. Alterando só irá atualizar
                                    automaticamente a versão do fix.(segundo número)
                                ...
                                <p>
                                    ...
                                    que queremos installar exatamente a versão passada.
                                </p>
                            </article>
                            ...
                            <p>
                                O module.exports é o objeto que vai deixar variáveis, constantes, funções objetos e arrays disponíveis 
                                para importarmos em outro arquivo. Temos três formas de referenciar esse objeto. O this, o exports e o 
                                próprio modules.exports. Vamos exemplificar. Se criarmos um arquivo com o nome exports.js e escrevermos 
                            ...
                            <p>
                                Essas três propriedades a, b e c estarão disponíveis para exportarmos em outros arquivos do nosso projeto.
                            </p>

                            <p>
                                Continuando com o exemplo, vamos criar outro arquivo com o nome import.js e escrever o seguinte código:
                            </p>
                            ...
                            <p>
                                Vamos receber como resposta do nosso console.log o seguinte:
                            </p>
                            ...
                            <p>
                                Vemos que as atribuições feitas pelas três formas de referenciar o módulo foram adicionadas ao objeto.
                            </p>

                            <article>
                                <h3>Observação</h3>
                                <p>caso passe para o this ou para o exports um novo objeto. O módulo não será alterado, pois esses são 
                                    apenas referências ao objeto. Para atribuir um novo abjeto ao módulo precisaríamos usar o module.exports 
                                    que é o objeto realmente.
                                </p>
                            </article>
                            ...
                            <h3>Módulo path</h3>
                            <p>
                                O path é uma das dependências pre-instaladas do Node mais importantes. Para vermos
                            ...
                            <article>
                                <h3>Observação</h3>
                                <p>Veja que o caminho passado para o path está apenas o 'path' sem o caminho relativo. Só 
                                    está com essa sintaxe simplificada pois os módulos pre-instalados estão disponiveis no próprio Node.
                                </p>
                            </article>
                            <p>
                                path significa caminho em português e é isso que o path vai nos informar. Com métodos simples
                                vamos saber em qual pasta está o arquivo, o diretório do projeto, as extenções dos arquivos entre
                                outras coisas.
                            </p>
                            <p>
                                O Node tem algumas variaveis globais, aqui vamos conhecer uma. <strong>__filename</strong>.
                            ...
                            <p>
                                ...
                                arquivo atual. Como parâmetro vamos passar o __filename que dirá em qual arquivo está sendo declarada 
                                essa variavel(no caso é no arquivo path.js).
                            </p>

                            <p>
                                Já para saber em qual diretório estamos, vamos ter que usar a função <strong>dirname</strong>, 
                                passando o __filename como parâmetro para informar em qual arquivo que estamos. Essa linha de código irá 
                            ...
                            <p>
                                ...
                                Basta usarmos o método <strong>parse</strong> com o __filename como parâmetro.
                            </p>

                            <p>
                                O path tambem pode juntar caminhos de arquivos com o método <strong>join</strong>. Aqui
                                vamos conhecer mais uma variável do Node o <strong>__dirname</strong> que vai armazenar o 
                                diretório onde está sendo declarado.
                            </p>
                            <p>
                                Para o método join vamos passar __dirname como parâmetro e o que queremos juntar com o 
                            ...
                            <p>
                                ...
                                <strong>C:\Users\humberto\Documents\estudos\modules\teste\teste.html</strong>.
                                Esse método vai servir para criarmos pastas com outro método muito importante que já vem
                                pré-instalado no Node, o <strong>fs</strong>.
                            </p>
                            <h3>método fs</h3>
                            <p>
                            ...
                            <pre>
                                fs.mkdir(path.join(__dirname, '/teste'), (error) = &gt; const msg = error ? console.log(error) : console.log(`Pasta criada!`))
                            </pre>


                            <p>
                                Nesse exemplo vemos que foram passados dois parâmetros para o método mkdir o path com o 
                                caminho que queremos construir e uma callback que recebe um erro e retorna um console.log.
                            </p>

                            <p>
                                Essa linha de código vai ser mostrar a mensagem que passamos de Pasta criada! no nosso terminal 
                                e se você for na pasta modules que foi o diretório onde escrevemos a linha de código. 
                                Verá que foi criada uma pasta com o nome teste, que foi 
